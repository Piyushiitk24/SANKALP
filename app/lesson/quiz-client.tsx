  ...
  const onContinue = () => {
    ...
    if (correctOption.id === selectedOption) {
      ...
      if (user) {
        ...
        const result = updateGuestChallengeProgress(challenge.id, lessonId, true);
        if (result.success) {
          void correctControls.play();
          setStatus("correct");
          setPercentage((prev) => prev + 100 / challenges.length);
          ...
          // Update challenge completion in local state
          challenges[activeIndex].completed = true;

          // This is a practice - add heart
          if (initialPercentage === 100) {
